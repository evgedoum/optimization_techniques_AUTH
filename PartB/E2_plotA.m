...
% Γραφικές παραστάσεις για σταθερό γκ=0.1.

% (x0,y0) = (0,0)
subplot(3,1,1)
[X,k] = megistikathodosA(f,e,x0(1),x0(2),gk);
...
% (x0,y0) = (-1,1)
subplot(3,1,2)
[X,k] = megistikathodosA(f,e,x0(3),x0(4),gk);
...
% (x0,y0) = (1,-1)
subplot(3,1,3)
[X,k] = megistikathodosA(f,e,x0(5),x0(6),gk);
